            ...
            <div className="section-padding animate-fade-in" style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div style={{ color: 'var(--text-secondary)', lineHeight: '1.8', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <section>
                        ...
                        <p>All bookings (Darshan, Sevas, Accommodations) and donations made through our system are final. We strive to process all requests accurately, but specific timings and availability are subject to the respective temple's final confirmation.</p>
